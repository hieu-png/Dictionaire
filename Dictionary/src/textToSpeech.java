...
public class textToSpeech {
    ...
    public textToSpeech() {
        ...
        //Gender not working for some reason
            /*
            String synthesizerGender;
            if(speakerGender == SpeakerGender.male) {
                synthesizerGender = "cmu_us_kal.KevinVoiceDirectory";
            } else {
                synthesizerGender = "cmu_time_awb.AlanVoiceDirectory";
            }*/
        System.setProperty(
                "freetts.voices",
